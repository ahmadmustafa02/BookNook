      ...
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <label className="px-3 py-2 border rounded-md flex items-center gap-2 dark:border-slate-600">
              <input
                type="text"
                className="grow outline-none rounded-md px-1 dark:bg-slate-800 dark:text-white bg-transparent"
                placeholder="Search"
